...
produce y de qué otros módulos depende. Mantener sincronizado con los docstrings.
...
| `schemas/fraud.py` | Esquema Pandera del dominio fraude + categorías válidas | ninguno | `fraud_schema`, `FRAUD_CATEGORIES` | pandera |
